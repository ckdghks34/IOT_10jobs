...
from std_msgs.msg import Float32, String, Int8MultiArray, ByteMultiArray
...
class Mapping:
    ...
    def show_pose_and_points(self, pose, laser_global):
        ...
        stringData = String()
        stringData.data = b64data.decode('utf-8')
        map_publisher.publish(stringData)
...
class Mapper(Node):
    ...
    def __init__(self):
        ...
        # 맵 정보 실시간 전송
        global map_publisher
        map_publisher = self.create_publisher(String, '/map_string', 10)
